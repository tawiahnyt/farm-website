  ...
  return (
    <main>
      ...
      <div className="my-20 px-6 lg:px-10 3xl:px-0 mx-auto max-w-[1440px] text-center justify-center0">
        <h2 className="pb-4 font-semibold font-mono text-4xl">Our Products</h2>
        ...
        <p className="mt-5 text-lg sm:text-xl/8 text-gray-500 font-medium">
          XYZ Ltd. is focused on achieving sustainable growth while meeting the
          needs of our stakeholders. Our company revolves around producing
          ...
          pride ourselves on our ability to provide both local and international
          markets with superior products that support food security and economic
          development.
        </p>
